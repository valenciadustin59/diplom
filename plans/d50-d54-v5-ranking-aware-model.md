...
- `dataset-v5` label sidecar includes page labels and query-level preferences.
- Split validation shows no query leakage.
- D50 failure queries are represented in preference evidence.
