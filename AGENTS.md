...
Канонические правила находятся в [PLANS.md](/E:/codexPROJ/diplom/PLANS.md).

Актуальный ML ExecPlan для training pipeline:

- [plans/real-ml-training-pipeline.md](/E:/codexPROJ/diplom/plans/real-ml-training-pipeline.md)
