...
- `D35-D36` должны довести модель до безопасного внедрения: shadow benchmark, explainability guardrails, controlled publish или documented keep-reference.
