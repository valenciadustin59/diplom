...
- D32 evidence: `backend/data/dataset_versions/dataset-v2/expert_labels.csv` has `197` labels generated by `scripts/generate_d32_expert_labels.py`; D33 is the next task and must apply them to `dataset.csv`, `manifest.json`, and `split.json`.
