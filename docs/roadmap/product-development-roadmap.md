...
Active post-publish operations tasks: apply deterministic expert labels, validate split/leakage/domain cap, then train/decide before any controlled publish.
