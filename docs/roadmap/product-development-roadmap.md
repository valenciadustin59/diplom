...
Current model next step: D82 produced a publishable non-production query-core candidate. Do not replace runtime automatically; run a separate controlled publish task only if the user explicitly chooses to make D82 active.
