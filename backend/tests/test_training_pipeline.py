...
def test_build_dataset_from_seed_csv_writes_dataset_and_failures(monkeypatch, tmp_path):
...
def test_train_quality_model_saves_model_and_exposes_model_info(tmp_path):
    dataset_path = tmp_path / "dataset.csv"
    ...
    assert saved_model["dataset_version"]
