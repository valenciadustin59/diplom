...
const humanLabelOverrides: Record<string, string> = {
  ...
  "Commercial completeness": "Коммерческая полнота",
  ...
  "Content depth": "Глубина контента",
  "Content richness": "Полнота контента",
  "Contact accessibility": "Доступность контактов",
  CTA: "Призыв к действию",
  "Depth and semantic match": "Глубина и смысловое соответствие",
